...
@Autonomous(name = "RED ONLY FOUNDATION - WALLPARK", group = "foundation")
public class OnlyFoundationRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.strafeStraight(1.0, ExplosivesRobot.Direction.LEFT,1000);
